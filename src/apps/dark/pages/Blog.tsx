...
import { IsItFridayYet } from '@src/shared-interfaces/isItFridayYet';
import { useLazy } from '@src/utils';

const BlogExample = () => {
  const t = useTranslations();

  useLazy(async (signal) => {
    const { answer } = await Backend.get<IsItFridayYet>('/is-it-friday-yet', { signal });
    alert(`Is it Friday yet: ${answer}`);
  });
